            ...
            <div class="border ruonded p-4">
                ...
                <form action="change_user_and_pass" method="post" id="change_password_form">
                    <label for="current_pass"> Current Password:
                        <input class="form-control" type="password" name="current_password" id="current_pass"
                            autocomplete>
                    </label>
                    ...
                    <label for="repeat_pass"> Confirm Password:
                        <input class="form-control" type="password" name="repeat_password" id="repeat_pass"
                            autocomplete>
                    </label><br>
